...
class DaoSolicitud extends DaoAdoptaUnProfe {
  ...
  async actualizarSolicitud(solicitud) {
    ...
    return this.query(sql, [solicitud.estado, solicitud.idProfesor, solicitud.idAlumno, solicitud.fecha, solicitud.horaInicio, solicitud.materia, solicitud.telefono])
  }
}
